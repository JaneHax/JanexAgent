...
>
> Use the Multiversal-owned namespace below for user-level Claude installs. Flat
> package-level destinations can collide with non-Multiversal rule packs and do not
> match the main README guidance.

```bash
# Create the Multiversal rule namespace once.
