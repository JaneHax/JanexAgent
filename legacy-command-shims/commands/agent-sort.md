...
- Classify Multiversal surfaces with concrete repo evidence.
- Keep the result to DAILY vs LIBRARY.
- If an install change is needed afterward, hand off to `configure-multiversal` instead of re-implementing install logic here.
