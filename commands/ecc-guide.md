---
description: Navigate Multiversal's current agents, skills, commands, hooks, install profiles, and docs from the live repository surface.
---

# /multiversal-guide

Use this command as a conversational map of Everything Claude Code. It should help the user discover the right Multiversal surface for their task without dumping the entire README or stale catalog counts.

## Usage

```text
/multiversal-guide
/multiversal-guide setup
/multiversal-guide skills
/multiversal-guide commands
/multiversal-guide hooks
/multiversal-guide install
/multiversal-guide find: <query>
/multiversal-guide <feature-or-file-name>
```
...
- `scripts/ci/catalog.js --json` for live catalog counts when running inside Multiversal
...
- `/project-init` for stack-aware Multiversal onboarding of a target project
