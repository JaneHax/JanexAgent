...
The script audits the current working directory by default and auto-detects whether the target is the Multiversal repo itself or a consumer project using Multiversal.
...
6. Suggested Multiversal skills to apply next.
